...
public class ListMediaActivity extends ParentMenuActivity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		/*
		 * Test d'un listage des identifiant des folower // database instantiate
		 * FollowerDb listeF = new FollowerDb(getApplicationContext());
		 * 
		 * // last X entries valuesF = listeF.getAllFollower();
		 * 
		 * for (int monint : valuesF) { System.out.println(monint); }
		 */
	}
}
